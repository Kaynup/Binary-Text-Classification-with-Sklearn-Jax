...
- **Inference Behavior**  
  ...
  - Example positive predictions:  
    - "This product is amazing!" â†’ 1  
    - "hi" â†’ 1  
    - "This is fabulous" â†’ 1  
  - Example negative predictions:  
    - "The boy looked so sad." â†’ 0  
    - "I had a very bad day." â†’ 0  
    - "You are the worst" â†’ 0  
    - "I like this place very much" â†’ 0  

- **Performance**  
  - Typical inference times: **1â€“3 ms** for short texts on CPU.  
  - Some outliers (e.g., ~800 ms) likely due to cold start or CPU fallback.  
  - After warm-up, predictions stabilized in the 1â€“20 ms range.

- **Errors Encountered**  
  - `'dict' object has no attribute 'predict'` â†’ indicates incorrect object passed into inference pipeline.  
  - `name 'vocab_size' is not defined` â†’ issue with model restoration code.  
